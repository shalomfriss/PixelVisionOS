...
function Init()
    ...
    if(success == true) then
        ...
        -- keyboard
        previousOctaveButtonData = editorUI:CreatePaletteButton({x = 0, y = 200 + 8}, "leftoctave", "Move up an octave.", PaletteOffset( 1))
        previousOctaveButtonData.onAction = PreviousOctave

        table.insert(disableWhenPlaying, previousOctaveButtonData)

        nextOctaveButtonData = editorUI:CreatePaletteButton({x = 0, y = 176 + 8}, "rightoctave", "Move down an octave.", PaletteOffset( 1))
